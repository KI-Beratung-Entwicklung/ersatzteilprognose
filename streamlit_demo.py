...
img = Image.open("ressources/Original on Transparent.png")
...
modelname_nn = 'models/gridnn_model.pkl'
...
def main():
        ...
        df = getDf('data/df_fuer_referenzprojekt.csv').tail(188347)
        land = getDf('data/maschinendaten_auf_karte.csv')
        df.drop(df.columns[[0,1,2]],axis=1,inplace=True)
        df["Artikelnummer"] = df["Artikelnummer"].astype('category')
        df_ready_for_ml = getDf('data/df_ml_ready_fuer_referenzprojekt.csv')
       ...
       3032860, 3036130, 3041900, 3026030, 3038570, 3029800, 3028282,
        ...
        st.sidebar.text("Info: Sicherer Modus")
        st.sidebar.text("Performance eingeschränkt")
        st.sidebar.text("Funktionen eingeschränkt")
        ...
        if rad == "Übersicht":
                ...
                path_to_html = "ressources/nettowert_per_country_map.html" 
        ...
        if rad == "Datenvisualisierung":
                ...
                if ansicht == "Alle Maschinen":    
                        ...
                        path_to_html = "ressources/nettowert_per_country_map_dots.html" 
                        # Read file and keep in variable
                        with open(path_to_html,'r') as f: 
                                map_dots = f.read()
                        ## Show in webpage
                        ...
                        with st.expander("Ersatzteilbedarfsverlaufkurve aller Maschinen"):
                                ...
                                if choice == "Artikelgruppenbasis":
                                        path_to_htmll = "ressources/Ersatzteil-Bedarfsverlauf_alle_Maschinen.html"
                                else:
                                        path_to_htmll = "ressources/Ersatzteil-Bedarfsverlauf_alle_Maschinen_Artikelebene.html"                
                                # Read file and keep in variable
                        ...
                        with st.expander("Verlaufskurven ausgewählter Werte aller Maschinen"):
                                ...
                                path_to_htmlll='ressources/Fakturierte Menge, Nettowert und Anzahl der Positionen im Zeitverlauf.html'
                        ...
                        with st.expander("Ersatzteil-Bedarfsverlauf aller Maschinen je Artikelgruppe"):
                                path_to_htmllll='ressources/Ersatzteil-Bedarfsverlauf_alle_Maschinen_Artikelgruppe_stackedbar.html'
        ...
        if rad == "Kontakt":
                ...
                with cols1:
                        ...
                        img2 = Image.open("ressources/wm_nor.jpg")
                        st.image(img2)
